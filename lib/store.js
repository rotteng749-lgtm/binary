...
function defaultState() {
  return { accounts: [], keys: [], games: [], activity: [], sessions: [] };
}
...
function seed(state) {
  const t = nowIso();
  state.games = [
    { id: 'mlbb', name: 'Mobile Legends', status: 'active', created_at: t },
    { id: 'ff', name: 'Free Fire', status: 'active', created_at: t },
    { id: 'pubg', name: 'PUBG Mobile', status: 'active', created_at: t },
  ];
  state.accounts = [
    {
